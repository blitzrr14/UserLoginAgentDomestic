...
{
    private String path;
    // DBConnection dbconnetwork;
    private DBConnection dbconnetwork;
    private String CloudServicePath;

    public Service()
    {
        path = "C:\\kpconfig\\userloginagent.ini";
       ...
       String Serv = ini.IniReadValue("network_config", "server");
       String DB = ini.IniReadValue("network_config", "database");
       String UID = ini.IniReadValue("network_config", "uid"); 
       String Password = ini.IniReadValue("network_config", "password"); 
       String pool = ini.IniReadValue("network_config", "pool");
       Int32 maxcon = Convert.ToInt32(ini.IniReadValue("network_config", "maxcon"));
       Int32 mincon = Convert.ToInt32(ini.IniReadValue("network_config", "mincon"));
       Int32 tout = Convert.ToInt32(ini.IniReadValue("network_config", "tout"));
       dbconnetwork = new DBConnection(Serv, DB, UID, Password, pool, maxcon, mincon, tout);

       CloudServicePath = ini.IniReadValue("CloudService", "Services");
    ...
    public versionsresponse getversion()
    {
        ...
        MySqlDataReader rdr;
        using (MySqlConnection connet = dbconnetwork.getConnection())
        {
            connet.Open();
    ...
    public response getdatasysuseraccounts(String modified, String created)
    {
        try
        {
            ...
            using (MySqlConnection con = dbconnetwork.getConnection())
            {
                ...
                using (MySqlCommand comm = con.CreateCommand())
                {
                    ...
                    for (int x = 0; x < dtacreate.Rows.Count; x++)
                    {
                        ...
                        endpoint = CloudServicePath + "/savesysuseraccountsglobal";
                        //endpoint = "http://localhost:41208/UserloginAgentCloudService/Service.svc/savesysuseraccountsglobal";
                    ...
                    comm.CommandText = "Select *, DATE_FORMAT(sysmodified,'%Y-%m-%d %T') as modi From `kpusers`.`sysuseraccounts` where sysmodified > @modified ORDER BY modi ASC;";
                           ...
                           // int updtusers = 0;
                            for (int x = 0; x < data.Rows.Count; x++)
                            {
                                ...
                                endpoint = CloudServicePath + "/savemodifiedsysuserglobal";
                               // endpoint = "http://localhost:41208/UserloginAgentCloudService/Service.svc/savemodifiedsysuserglobal";
            ...
            return new response { respcode = 102, respmsg = "Cloud database is more up to date than network!" };
        }
        catch (Exception ex)
        {
    ...
    public response getdatabranchusers(String modified, String created)
    {
        try
        {
                ...
                using (MySqlCommand comm = con.CreateCommand())
                {
                   ...
                   // int createnew = 0;
                    ...
                    for (int x = 0; x < dtacreate.Rows.Count; x++)
                    {
                        ...
                        endpoint = CloudServicePath + "/savebranchuser";
                   ...
                   // int updtusers = 0;
                    for (int x = 0; x < data.Rows.Count; x++)
                    {
                        ...
                        endpoint = CloudServicePath + "/savemodifiedbranchuser";
                        info = "{\"BranchCode\":\"" + BranchCode + "\",\"resourceID\":\"" + resourceID + "\",\"IsReliever\":\"" + IsReliever + "\", \"IsActiveReliever\":\"" + IsActiveReliever + "\", \"syscreated\":\"" + syscreated +
                            "\", \"sysmodified\":\"" + sysmodified + "\",\"ZoneCode\":\"" + ZoneCode + "\",\"fullname\":\"" + fullname + "\",\"lastname\":\"" + lastname + "\",\"firstname\":\"" + firstname + "\",\"middlename\":\"" + middlename + "\", \"syscreator\":\"" + syscreator + "\", \"sysmodifier\":\"" + sysmodifier + "\"}";
                        var urimod = new Uri(endpoint);
                        dataresp = Encoding.UTF8.GetBytes(info);
            ...
            return new response { respcode = 102 , respmsg = "Cloud is more up to date than Network!"};
        }
        catch (Exception ex)
        {
            return new response { respcode = 101, respmsg = ex.ToString() };
            ...
            using (MySqlConnection con = dbconnetwork.getConnection())
            {
                ...
                using (MySqlCommand comm = con.CreateCommand())
                {
                    ...
                    for (int x = 0; x < dtacreate.Rows.Count; x++)
                    {
                        ...
                        endpoint = CloudServicePath + "/savemlbranchesstations";
            ...
            using(MySqlConnection con = dbconnetwork.getConnection())
            {
                ...
                using(MySqlCommand comm = con.CreateCommand())
                {
                    ...
                    for (int x = 0; x < dtacreate.Rows.Count; x++)
                    {
                        ...
                        endpoint = CloudServicePath + "/saveadminusers";
                ...
                return new response { respcode = 101, respmsg = "Cloud database is more up to date than network!"};
    ...
    public response getdataarea(String modified, String created)
    {
     ...
     //   Int32 ID = 0;
        ...
        using (MySqlConnection con = dbconnetwork.getConnection())
        {
            ...
            using (MySqlCommand comm = con.CreateCommand())
            {
                ...
                for (int x = 0; x < dtacreate.Rows.Count; x++)
                {
                   // ID = Convert.ToInt32(dtacreate.Rows[x]["ID"]);
                    ...
                    endpoint = CloudServicePath + "/savearea";
            ...
            return new response { respcode = 101, respmsg = "Cloud is more up to date than network!" };
        ...
        using (MySqlConnection con = dbconnetwork.getConnection())
        {
            ...
            using (MySqlCommand comm = con.CreateCommand())
            {
                ...
                for (int x = 0; x < dtacreate.Rows.Count; x++)
                {
                    ...
                    endpoint = CloudServicePath + "/savebranches";
        ...
        using (MySqlConnection con = dbconnetwork.getConnection())
        {
            ...
            using (MySqlCommand comm = con.CreateCommand())
            {
                ...
                for (int x = 0; x < dtacreate.Rows.Count; x++)
                {
                    ...
                    endpoint = CloudServicePath + "/saveregion";
        ...
        using (MySqlConnection con = dbconnetwork.getConnection())
        {
            ...
            using (MySqlCommand comm = con.CreateCommand())
            {
                ...
                for (int x = 0; x < dtacreate.Rows.Count; x++)
                {
                    ...
                    endpoint = CloudServicePath + "/savesysuserroles";
        ...
        using (MySqlConnection con = dbconnetwork.getConnection())
        {
            ...
            using (MySqlCommand comm = con.CreateCommand())
            {
                ...
                for (int x = 0; x < dtacreate.Rows.Count; x++)
                {
                    ...
                    endpoint = CloudServicePath + "/saveroles";
        ...
        using (MySqlConnection con = dbconnetwork.getConnection())
        {
            ...
            using (MySqlCommand comm = con.CreateCommand())
            {
                ...
                for (int x = 0; x < dtacreate.Rows.Count; x++)
                {
                  ...
                  // endpoint = CloudServicePath + "/savezonecodes";
                    endpoint = CloudServicePath + "/savezonecodes";
   ...
   // }
        ...
        using (MySqlConnection connet = dbconnetwork.getConnection())
        {
            ...
            using (MySqlCommand cmd = connet.CreateCommand())
            {
                ...
                else if (!datereleased.Equals(string.Empty))
                {
                    ...
                    cmd.Parameters.Clear();
                    cmd.Parameters.AddWithValue("released", Convert.ToDateTime(datereleased));
                    adptr.SelectCommand = cmd;
                    adptr.Fill(dtaset);
                    table = dtaset.Tables[0];
                    List<versionsdetails> details = new List<versionsdetails>();
                ...
                return new versionsresponse { respcode = 0, respmsg = "Cloud is more up to date than network!" };
            }
        }
    }
    ...
    public response sysuseraccounts()
    {
        ...
        try
        {
            ...
            String maxcreated = string.Empty;
            ServicePointManager.ServerCertificateValidationCallback = new RemoteCertificateValidationCallback(delegate { return true; });
            // String endpoint = CloudServicePath + "/getdatasysuseraccounts";
            String endpoint = CloudServicePath + "/getdatasysuseraccounts";
            using (MySqlConnection con = dbconnetwork.getConnection())
            {
                con.Open();
    ...
    public response branchusers()
    {
        try
        {
            ...
            String maxcreated = string.Empty;
            ServicePointManager.ServerCertificateValidationCallback = new RemoteCertificateValidationCallback(delegate { return true; });
            String endpoint = CloudServicePath + "/getdatabranchusers/";
            using (MySqlConnection con = dbconnetwork.getConnection())
            {
                con.Open();
                using (MySqlCommand comm = con.CreateCommand())
        ...
        try
        {
            ...
            using (MySqlConnection con = dbconnetwork.getConnection())
            {
                ...
                using (MySqlCommand comm = con.CreateCommand())
                {
                    ...
                    ServicePointManager.ServerCertificateValidationCallback = new RemoteCertificateValidationCallback(delegate { return true; });
                    String endpoint = CloudServicePath + "/getdatamlbranchesstations";
                    var client = new HttpUtils.RestClient(endpoint);
                    var jsonresponse = client.MakeRequest("/?modified=" + maxmodified + "&created=" + maxcreated + "");
                    dynamic result = JObject.Parse(jsonresponse.ToString());
                    Int32 statcode = result.respcode;
                ...
                using (MySqlConnection con = dbconnetwork.getConnection())
                {
                    ...
                    using (MySqlCommand comm = con.CreateCommand())
                    {
                        try
                        {
                            ...
                            ServicePointManager.ServerCertificateValidationCallback = new RemoteCertificateValidationCallback(delegate { return true; });
                            String endpoint = CloudServicePath + "/getdataadminusers";
                            // String endpoint = CloudServicePath + "/getdataadminusers";
                            var client = new HttpUtils.RestClient(endpoint);
                            var jsonresponse = client.MakeRequest("/?modified=" + maxmodified + "&created=" + maxcreated + "");
                            dynamic result = JObject.Parse(jsonresponse.ToString());
                ...
                using (MySqlConnection con = dbconnetwork.getConnection())
                {
                    ...
                    using (MySqlCommand comm = con.CreateCommand())
                    {
                        try
                        {
                            ...
                            ServicePointManager.ServerCertificateValidationCallback = new RemoteCertificateValidationCallback(delegate { return true; });
                            String endpoint = CloudServicePath + "/getdataarea";
                            var client = new HttpUtils.RestClient(endpoint);
                            var jsonresponse = client.MakeRequest("/?modified=" + maxmodified + "&created=" + maxcreated + "");
                            dynamic result = JObject.Parse(jsonresponse.ToString());
                            Int32 statcode = result.respcode;
                ...
                using (MySqlConnection con = dbconnetwork.getConnection())
                {
                    ...
                    using (MySqlCommand comm = con.CreateCommand())
                    {
                        try
                        {
                            ...
                            ServicePointManager.ServerCertificateValidationCallback = new RemoteCertificateValidationCallback(delegate { return true; });
                            String endpoint = CloudServicePath + "/getdatabranches";
                            var client = new HttpUtils.RestClient(endpoint);
                            var jsonresponse = client.MakeRequest("/?modified=" + maxmodified + "&created=" + maxcreated + "");
                            dynamic result = JObject.Parse(jsonresponse.ToString());
                            Int32 statcode = result.respcode;
                ...
                using (MySqlConnection con = dbconnetwork.getConnection())
                {
                    ...
                    using (MySqlCommand comm = con.CreateCommand())
                    {
                        try
                        {
                            ...
                            ServicePointManager.ServerCertificateValidationCallback = new RemoteCertificateValidationCallback(delegate { return true; });
                            //  String endpoint = CloudServicePath + "/getdatazonecodes";
                            String endpoint = CloudServicePath + "/getdatazonecodes";
                            var client = new HttpUtils.RestClient(endpoint);
                            var jsonresponse = client.MakeRequest("/?modified=" + maxmodified + "&created=" + maxcreated + "");
                            dynamic result = JObject.Parse(jsonresponse.ToString());
                ...
                using (MySqlConnection con = dbconnetwork.getConnection())
                {
                    ...
                    using (MySqlCommand comm = con.CreateCommand())
                    {
                        try
                        {
                            ...
                            ServicePointManager.ServerCertificateValidationCallback = new RemoteCertificateValidationCallback(delegate { return true; });
                            String endpoint = CloudServicePath + "/getdataregion";
                            var client = new HttpUtils.RestClient(endpoint);
                            var jsonresponse = client.MakeRequest("/?modified=" + maxmodified + "&created=" + maxcreated + "");
                            dynamic result = JObject.Parse(jsonresponse.ToString());
                            Int32 statcode = result.respcode;
                ...
                using (MySqlConnection con = dbconnetwork.getConnection())
                {
                    ...
                    using (MySqlCommand comm = con.CreateCommand())
                    {
                        try
                        {
                            ...
                            ServicePointManager.ServerCertificateValidationCallback = new RemoteCertificateValidationCallback(delegate { return true; });
                            String endpoint = CloudServicePath + "/getdatasysuserroles";
                            // String endpoint = CloudServicePath + "/getdatasysuserroles";
                            var client = new HttpUtils.RestClient(endpoint);
                            var jsonresponse = client.MakeRequest("/?modified=" + maxmodified + "&created=" + maxcreated + "");
                            dynamic result = JObject.Parse(jsonresponse.ToString());
                ...
                using (MySqlConnection con = dbconnetwork.getConnection())
                {
                    ...
                    using (MySqlCommand comm = con.CreateCommand())
                    {
                        try
                        {
                            ...
                            ServicePointManager.ServerCertificateValidationCallback = new RemoteCertificateValidationCallback(delegate { return true; });
                            // String endpoint = CloudServicePath + "/getdatarr";
                            String endpoint = CloudServicePath + "/getdataroles";
                            var client = new HttpUtils.RestClient(endpoint);
                            var jsonresponse = client.MakeRequest("/?modified=" + maxmodified + "&created=" + maxcreated + "");
                            dynamic result = JObject.Parse(jsonresponse.ToString());
                            Int32 statcode = result.respcode;
    ...
    public versionsresponse checkversionGlobal(String callType)
    {
        ...
        endpoint = CloudServicePath + "/getversion";
        var client = new HttpUtils.RestClient(endpoint);
        ...
        ServicePointManager.ServerCertificateValidationCallback = new RemoteCertificateValidationCallback(delegate { return true; });
        endpoint = CloudServicePath + "/getupdatedversionsGlobal";
        Int32 type = 0;
        ...
        if (callType == "Updates")
        {
            ...
            if (cloudupdatesclient != netupdatesclient)
            {
                ...
                var response = client.MakeRequest("/?updatesversion=" + cloudupdatesclient + "&versions=" + versions + "&type=" + type + "&datereleased=" + string.Empty + "");
            ...
            if (cloudupdatesadmin != netupdatesadmin)
            {
                ...
                // call network's method for updates
                client = new HttpUtils.RestClient(endpoint);
                var response = client.MakeRequest("/?&updatesversion=" + cloudupdatesadmin + "&versions=0.0&type=" + type + "&datereleased=" + string.Empty + "");
                mr = JsonConvert.DeserializeObject<menuReturn>(response);
    ...
    //  ------------------------------------------ SAVING DATAS FROM CLOUD TO NETWORK FOR USERLOGINAGENT NETWORK -------------------------------------------------------------------
    ...
    public response savemodifiedsysuserglobal(string resourceID, string UserPassword, string sysmodified)
    {
        ...
        using (MySqlConnection connet = dbconnetwork.getConnection())
        {
            ...
            using (MySqlCommand cmd = connet.CreateCommand())
            {
                String updatekpusers = "UPDATE kpusers.sysuseraccounts SET userpassword=@pword, sysmodified=@modified where resourceid=@resourceid;";
